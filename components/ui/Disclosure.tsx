...
export function Disclosure({ expanded, onToggle, collapsedLabel, expandedLabel, children, className = "" }: DisclosureProps) {
  return (
    <div className={className}>
      <button type="button" aria-expanded={expanded} onClick={onToggle}
        ...
        <span aria-hidden className={`inline-block transition-transform duration-200 ${expanded ? "rotate-180" : ""}`}>⌄</span>
      </button>
